...
def make_withdraw(balance, password):
    ...
    "*** YOUR CODE HERE ***"
    lst=[]
    def withdraw(amount,return_password):
        nonlocal balance
        if len(lst)==3:
            return "Your account is locked. Attempts: %s" % lst
        elif return_password!=password:
            lst.append(return_password)
...
class Coin:
    ...
    def worth(self):
        diff_year = Mint.current_year - self.year
        if diff_year > 50:
            return self.cents + (diff_year - 50)
        else:
            return self.cents
...
class VendingMachine:
    ...
    def vend(self):
        ...
        if change <0:
            ...
            self.balance = 0
            self.stock -=1
            return 'Here is your {0} and ${1} change.'.format(self.kind , abs(change))
        else:
            self.balance = 0
            self.stock -= 1
