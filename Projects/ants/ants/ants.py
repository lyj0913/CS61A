...
class Insect(object):
    ...
    def __init__(self, armor, place=None):
        ...
        self.armor = armor
        self.place = place
        self.bee_scared = False
        self.direction = 1 # set by Place.add_insect and Place.remove_insect
...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        "*** YOUR CODE HERE ***"
        if self.bee_scared is False and self.direction == -1:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while count <= self.max_range:
            if place.entrance != hive and len(place.bees) == 0:
                place = place.entrance
                count += 1
            else:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        """
        # BEGIN Problem 5
        if 0 >= self.amor - amount: #fireant dies
...
class BodyguardAnt(Ant):
    ...
    def contain_ant(self, ant): #ant store ant here
        # BEGIN Problem 9
        ...
        if self.imposter == False:
            ...
            while cur_place is not None:
                ...
                if ant != None:
                    ...
                    if ant.is_container and ant.contained_ant not in QueenAnt.antsdoubled and ant.contained_ant is not None:

                        ant.contained_ant.damage *= 2

                        QueenAnt.antsdoubled.extend([ant.contained_ant])

                    if ant not in QueenAnt.antsdoubled:
                        ant.damage *= 2
                        QueenAnt.antsdoubled.extend([cur_place.ant])
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        if target and target.bee_scared == False:
